...
The API could provide a mechanism to frame messages.
This would allow byte-stream based transport layer data to be transformed to and from useful message data.
