...
knowing the size of the data being transfered.
...
Since implementing this as a compile-time error is non-trivial, and does not impact the useabilty of the API, this will
...
Rust will be used for demonstrating the ideas discussed as it supports the required features.
